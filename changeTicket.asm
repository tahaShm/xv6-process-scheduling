...
_changeTicket:     file format elf32-i386
...
int main (int argc, char* argv[]) {
  ...
  13:	8b 59 04             	mov    0x4(%ecx),%ebx
    ...
    evalTicket(atoi(argv[1]), atoi(argv[2]));
  16:	ff 73 08             	pushl  0x8(%ebx)
  ...
  2b:	56                   	push   %esi
  2c:	50                   	push   %eax
  2d:	e8 08 03 00 00       	call   33a <evalTicket>
...
00000342 <evalRemainingPriority>:
...
000005d0 <free>:
 ...
 60f:	a3 0c 0a 00 00       	mov    %eax,0xa0c
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 64a:	a3 0c 0a 00 00       	mov    %eax,0xa0c
...
00000660 <malloc>:
 ...
 6b1:	39 05 0c 0a 00 00    	cmp    %eax,0xa0c
 ...
 6db:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
 ...
 707:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
 ...
 727:	0a 00 00 
 72a:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 731:	0a 00 00 
 734:	b8 10 0a 00 00       	mov    $0xa10,%eax
 739:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 740:	00 00 00 
