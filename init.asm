...
main(void)
{
  ...
  60:	e8 5b 04 00 00       	call   4c0 <printf>
    pid = fork();
  65:	e8 e0 02 00 00       	call   34a <fork>
    if(pid < 0){
  ...
  78:	e8 dd 02 00 00       	call   35a <wait>
  ...
  99:	53                   	push   %ebx
  9a:	53                   	push   %ebx
  9b:	68 33 08 00 00       	push   $0x833
  a0:	6a 01                	push   $0x1
  a2:	e8 19 04 00 00       	call   4c0 <printf>
      exit();
  a7:	e8 a6 02 00 00       	call   352 <exit>
      exec("sh", argv);
  ac:	50                   	push   %eax
  ad:	50                   	push   %eax
  ae:	68 48 0b 00 00       	push   $0xb48
  b3:	68 46 08 00 00       	push   $0x846
  b8:	e8 cd 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  bd:	5a                   	pop    %edx
  be:	59                   	pop    %ecx
  bf:	68 49 08 00 00       	push   $0x849
  c4:	6a 01                	push   $0x1
  c6:	e8 f5 03 00 00       	call   4c0 <printf>
      exit();
  cb:	e8 82 02 00 00       	call   352 <exit>
    mknod("console", 1, 1);
  d0:	51                   	push   %ecx
  d1:	6a 01                	push   $0x1
  d3:	6a 01                	push   $0x1
  d5:	68 18 08 00 00       	push   $0x818
  da:	e8 bb 02 00 00       	call   39a <mknod>
    open("console", O_RDWR);
  df:	5b                   	pop    %ebx
  e0:	58                   	pop    %eax
  e1:	6a 02                	push   $0x2
  e3:	68 18 08 00 00       	push   $0x818
  e8:	e8 a5 02 00 00       	call   392 <open>
...
000003f2 <changeQueueNum>:
SYSCALL(changeQueueNum)
...
00000402 <evalRemainingPriority>:
SYSCALL(evalRemainingPriority)
 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 457:	f7 f1                	div    %ecx
 459:	0f b6 92 a0 08 00 00 	movzbl 0x8a0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb 98 08 00 00       	mov    $0x898,%ebx
        while(*s != 0){
 ...
 691:	a1 50 0b 00 00       	mov    0xb50,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 50 0b 00 00       	mov    %eax,0xb50
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
 ...
 6e6:	72 ce                	jb     6b6 <free+0x26>
{
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 50 0b 00 00       	mov    %eax,0xb50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 77e:	56                   	push   %esi
 77f:	e8 56 fc ff ff       	call   3da <sbrk>
  if(p == (char*)-1)
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 50 0b 00 00    	mov    %edx,0xb50
}
 ...
 7d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 50 0b 00 00 54 	movl   $0xb54,0xb50
 7e7:	0b 00 00 
 7ea:	c7 05 54 0b 00 00 54 	movl   $0xb54,0xb54
 7f1:	0b 00 00 
    base.s.size = 0;
 7f4:	b8 54 0b 00 00       	mov    $0xb54,%eax
 7f9:	c7 05 58 0b 00 00 00 	movl   $0x0,0xb58
 800:	00 00 00 
