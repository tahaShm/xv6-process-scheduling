...
int main (int argc, char* argv[]) {
  ...
  18:	7e 0e                	jle    28 <main+0x28>
    ...
    printInfo();
  1a:	e8 2b 03 00 00       	call   34a <printInfo>

    exit();
  1f:	e8 6e 02 00 00       	call   292 <exit>
  24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        int pid2 = fork();
  28:	e8 5d 02 00 00       	call   28a <fork>
        if (pid2 > 0) {
  2d:	85 c0                	test   %eax,%eax
  2f:	7e 02                	jle    33 <main+0x33>
  31:	eb fe                	jmp    31 <main+0x31>
  33:	eb fe                	jmp    33 <main+0x33>
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
